...
if  os.path.exists(datapath):
    ...
    # Limpeza
    df_limpo = df.drop(["User ID", "User Behavior Class"], axis = 1)
    df_limpo['Gender'] = df_limpo['Gender'].replace({'Female': 'Feminino', 'Male': 'Masculino'})
    ...
    # Exibir gráficos com base na aba selecionada
        ...
        pg.usuarios_faixa_etaria(df_limpo)
        ...
        pg.aplicativos_faixa_etaria(df_limpo)
